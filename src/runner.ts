...
Examples:
  npm run exp -- --outDir results/fig1 --seedBase 1000 --seeds 50 --maxAgents 1000 \\
    --noise 0 --inflowStart 0 --inflowEnd 0.172 --inflowStep 0.002

  npm run exp -- --outDir results/fig9 --seedBase 1000 --seeds 50 --maxAgents 1000 \\
...
async function main() {
  ...
  writeFileSync(
    ...
    JSON.stringify(
      {
        note: 'A-mode: thermodynamic "entropy" vocabulary removed; dissipation proxies reported.',
        effectiveParams: {
